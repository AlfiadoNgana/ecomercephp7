<?php
    ...
    class Cart extends Model{
        ...
        public function getSessionFromId(){
            $sql = new Sql();
            $results = $sql->select("SELECT * FROM tb_carts WHERE dessession = :dessession",[':dessession'=>session_id()]);
            if(count($results)>0){
        ...
        public function getProducts(){
            $sql = new Sql();
            $rows = $sql->select("
                SELECT b.idproduct, b.desproduct, b.vlprice, b.vlwidth, b.vlheight, b.vllength, b.vlweight,b.desurl, COUNT(*) AS nrqtd, SUM(b.vlprice) AS vltotal FROM 
                tb_cartsproducts a INNER JOIN tb_products b ON a.idproduct=b.idproduct
